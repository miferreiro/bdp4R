...
#' @param pathOutPut (character) Path of the file where the csv or dataFrame of
#' the processed instances will be saved without the synsets.
#' @param pathOutPutSynsets (character) Path of the file where the csv or
...
#'
bdp4R_execute = function(pathKeys,
                         pathFiles,
  ...
  listInstances <- bdp4R_object$proccess_files(pathFiles,
                                               pipe = pipe,
